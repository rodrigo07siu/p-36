...
this.buddy = null;// Escribe el bloque de código correcto para agregar un botón que corte la cuerda.
}  
...
function draw() 
{
  ...
  if(collide(fruit,bunny,80)==true)
  {
   ...
   bubble.visible = false;
    ...
    fruit = null;
   bunny.changeAnimation("eat",eat);// Código para cambiar la animación del conejito cuando colisiona con la fruta y el conejito es detectado.  
  }
